...
# Utilice la NewType()funcion auxiliar para crear tipos distintos:
...
# Simplicando valores para saber si un numero esta dentro de un rango
...
def scale(scalar: float, vector: Vector) -> Vector:
        ...
        se trataran como sinonimos intercambiables:
        """
...
# Funcion cuando esta fuera de una clase y metodo cuando esta dentro.

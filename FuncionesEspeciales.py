...
class AbstractClass(ABC): # Abstract Base Class
	...
	def calcular_area(self):
		'''
		Si una clase tiene un método abstracto, toda la clase se convierte en una clase abstracta.
...
class TestClass(): # Es igual a TestClass(Object): porque todas las clases heredan de object.
	...
	def __str__(self):
		...
		print(f'TestClass A: {self.a}, B: {self.c}')
...
print(newObject) # Imprime una direccion de memoria, si no tiene sobreescrita el metodo __str__
